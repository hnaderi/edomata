...
ALTER TABLE "catalog".states ENABLE ROW LEVEL SECURITY;
CREATE POLICY states_tenant_policy ON "catalog".states
  USING (tenant_id = current_setting('app.tenant_id'));
GRANT SELECT, INSERT, UPDATE ON "catalog".states TO app_user;
ALTER TABLE "catalog".outbox ENABLE ROW LEVEL SECURITY;
CREATE POLICY outbox_tenant_policy ON "catalog".outbox
  USING (tenant_id = current_setting('app.tenant_id'));
GRANT SELECT, INSERT, UPDATE ON "catalog".outbox TO app_user;
