...
{"l":"edomata/core/Decision.html","n":">>","t":"def >>[R2 >: R, E2 >: E, B](f: => Decision[R2, E2, B]): Decision[R2, E2, B]","d":"edomata/core/Decision","k":"def"},
{"l":"edomata/core/Decision.html","n":">>=","t":"def >>=[R2 >: R, E2 >: E, B](f: A => Decision[R2, E2, B]): Decision[R2, E2, B]","d":"edomata/core/Decision","k":"def"},
...
{"l":"edomata/core/Decision.html","n":"void","t":"def void: Decision[R, E, Unit]","d":"edomata/core/Decision","k":"def"},
...
{"l":"edomata/core/DecisionConstructors.html","n":"apply","t":"def apply[R, E, T](t: T): Decision[R, E, T]","d":"edomata/core/DecisionConstructors","k":"def"},
...
{"l":"edomata/core/DecisionTConstructors.html","n":"unit","t":"def unit[F[_] : Applicative, R, E]: DecisionT[F, R, E, Unit]","d":"edomata/core/DecisionTConstructors","k":"def"},
...
{"l":"edomata/core/DomainCompiler$.html","n":"execute","t":"def execute[F[_] : Monad, C, S, E, R, N](app: Edomaton[F, RequestContext[C, S], R, E, N, Unit], ctx: RequestContext[C, S])(implicit evidence$1: Monad[F], m: ModelTC[S, E, R]): F[EdomatonResult[S, E, R, N]]","d":"edomata/core/DomainCompiler$","k":"def"},
...
{"l":"edomata/core/Edomaton.html","n":"Edomaton","t":"class Edomaton[F[_], -Env, R, E, N, A](run: Env => F[Response[R, E, N, A]]) extends AnyVal","d":"edomata/core/Edomaton","k":"class"},
...
{"l":"edomata/core/EdomatonResult.html","n":"EdomatonResult","t":"enum EdomatonResult[S, E, R, N]","d":"edomata/core/EdomatonResult","k":"enum"},
{"l":"edomata/core/EdomatonResult$$Accepted.html","n":"Accepted","t":"case Accepted[S, E, R, N](newState: S, events: Type[E], notifications: Chain[N])","d":"edomata/core/EdomatonResult","k":"case"},
{"l":"edomata/core/EdomatonResult$$Indecisive.html","n":"Indecisive","t":"case Indecisive[S, E, R, N](notifications: Chain[N])","d":"edomata/core/EdomatonResult","k":"case"},
{"l":"edomata/core/EdomatonResult$$Rejected.html","n":"Rejected","t":"case Rejected[S, E, R, N](notifications: Chain[N], reasons: Type[R])","d":"edomata/core/EdomatonResult","k":"case"},
{"l":"edomata/core/EdomatonResult$$Conflicted.html","n":"Conflicted","t":"case Conflicted[S, E, R, N](reasons: Type[R])","d":"edomata/core/EdomatonResult","k":"case"},
{"l":"edomata/core/EdomatonResult$$Accepted.html","n":"Accepted","t":"case Accepted[S, E, R, N](newState: S, events: Type[E], notifications: Chain[N])","d":"edomata/core/EdomatonResult$$Accepted","k":"case"},
{"l":"edomata/core/EdomatonResult$$Indecisive.html","n":"Indecisive","t":"case Indecisive[S, E, R, N](notifications: Chain[N])","d":"edomata/core/EdomatonResult$$Indecisive","k":"case"},
{"l":"edomata/core/EdomatonResult$$Rejected.html","n":"Rejected","t":"case Rejected[S, E, R, N](notifications: Chain[N], reasons: Type[R])","d":"edomata/core/EdomatonResult$$Rejected","k":"case"},
{"l":"edomata/core/EdomatonResult$$Conflicted.html","n":"Conflicted","t":"case Conflicted[S, E, R, N](reasons: Type[R])","d":"edomata/core/EdomatonResult$$Conflicted","k":"case"},
